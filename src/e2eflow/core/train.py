...
from e2eflow.resp_and_card.input_resp import DataGenerator_3D, DataGenerator_2D, DataGenerator_Resp_train_2D
...
def train(ModelResp, general_setup, experiment_setup):
    ...
    if not os.path.exists(f'/home/studghoul1/lapnet/logs/checkpoints/{checkpoint_file}'):
        os.makedirs(f'/home/studghoul1/lapnet/logs/checkpoints/{checkpoint_file}')
    ...
    # weights_path = '/home/studghoul1/lapnet/logs/checkpoints/3D_training/3D_experiment_01.hd5f'
    # ModelResp.load_weights(weights_path)

    # Checkpoints
    checkpoints = ModelCheckpoint(
        f'/home/studghoul1/lapnet/logs/checkpoints/{checkpoint_file}/{experiment_name}_' + '{epoch:02d}' + '.hd5f',
        save_weights_only=True,
        save_freq="epoch")

    # TensorBoard
    """tb_callback = tf.keras.callbacks.TensorBoard(log_dir='/home/studghoul1/lapnet/logs/graphs/', update_freq=2000)"""

    # CSVLogger logs epoch, acc, loss, val_acc, val_loss
    log_csv = CSVLogger('/home/studghoul1/lapnet/logs/my_logs/3D_training/{}.csv'.format(experiment_name),
                        separator=',',
                        append=False)
    ...
    # define callbacks
    callbacks_list = [scheduler, checkpoints, log_csv]
